...
<body>
	<%--
		...
		1-2-3-4-2-3-4-2-3-4.... 이렇게 반복
	    begin: 시작 인덱스
	    end: 종료 인덱스
	    step: 증감 값(default= 1) 그래서 꼭 안해도 된다
	...
	<%
		...
		// list : 순차적으로 접근하고 싶을 때 for(String str : list) ==> 리스트에 담겨있는 모든 값에 대해 처리
		// map에 담겨진 모든 값을 확인??
	...
	var 속성을 적용한 경우 : var 속성으로 저장만 된다(el을 통해 활용)<c:url value="/userRegist" var="url"/>${url}
</body>
</html>